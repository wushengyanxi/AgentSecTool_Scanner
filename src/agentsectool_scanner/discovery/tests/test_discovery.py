"""发现层单测（stdlib unittest，`python3 -m unittest agentsectool_scanner.discovery.tests.test_discovery`）。"""

import os
import tempfile
import unittest

from agentsectool_scanner.discovery import active, merge, passive
from agentsectool_scanner.discovery import blocklist as bl
