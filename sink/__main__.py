"""落地 CLI：
  python3 -m sink --db scan.sqlite --in results.jsonl   # 入库
  python3 -m sink --db scan.sqlite --stats              # 只统计
  python3 -m sink --db scan.sqlite --report out.html    # 出报告（按后缀定格式：.html/.json/.csv/.txt）
"""
