...
用法（项目根目录，需 .venv 里的 geoip2）：
  .venv/bin/python3 -m agentsectool_scanner.geoip.backfill
  .venv/bin/python3 -m agentsectool_scanner.geoip.backfill --all
  .venv/bin/python3 -m agentsectool_scanner.geoip.backfill --db path.sqlite
"""
