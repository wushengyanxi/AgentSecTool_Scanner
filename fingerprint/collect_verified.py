...
用法：
  python3 fingerprint/collect_verified.py --versions-file missing.txt
  python3 fingerprint/collect_verified.py --only 2026.6.9 2026.6.8
"""
import argparse
...
DB_PATH = "fingerprints/fingerprints.json"
